export type TokenSwap = {
  ...
  instructions: [
    ...
    },
    {
      ...
      docs: ["Initializes a new swap"];
      accounts: [
        {
          name: "swapPool";
          isMut: true;
          isSigner: false;
          docs: ["New Token-swap to create."];
        },
        {
          name: "authority";
          isMut: false;
        ...
        },
        {
          ...
          isMut: true;
          isSigner: false;
          docs: ["Pool Token Mint. Must be empty, owned by swap authority."];
        },
        {
          name: "feeReceiver";
          isMut: false;
    ...
    {
      name: "swap";
      docs: ["Swap the tokens in the pool."];
      accounts: [
        {
          name: "swapPool";
          isMut: false;
        ...
        },
        {
          ...
          isSigner: false;
          isOptional: true;
          docs: ["Host fee account to receive additional trading fees"];
        }
      ];
      args: [
        {
  ...
  accounts: [
    {
      name: "swapPool";
      docs: ["A token swap pool."];
      type: {
        kind: "struct";
        fields: [
          {
            name: "isInitialized";
            docs: ["Initialized state."];
            type: "bool";
          },
          {
            name: "bump";
          ...
          {
            name: "tokenProgram";
            docs: ["Program ID of the tokens being exchanged."];
            type: "publicKey";
          },
          {
            name: "mintA";
  ...
  types: [
    {
      ...
      docs: ["ConstantPriceCurve struct implementing CurveCalculator"];
      type: {
        kind: "struct";
        fields: [
          {
            name: "tokenBPrice";
            docs: ["Amount of token A required to get 1 token B"];
            type: "u64";
          }
        ];
      };
    },
    {
      ...
      docs: ["ConstantProductCurve struct implementing CurveCalculator"];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "tokenBOffset";
            docs: ["Amount to offset the token B liquidity account"];
            type: "u64";
          }
        ];
      };
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["Owner withdraw fee denominator"];
            type: "u64";
          },
          {
          ...
          },
          {
            ...
            docs: ["Host trading fee denominator"];
            type: "u64";
          }
        ];
      };
